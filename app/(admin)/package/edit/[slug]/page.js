            ...
            <div className="row g-0">
              ...
              <div className="col-lg-7 p-4 p-md-5 bg-white" style={{ borderRightWidth: "1px", borderRightColor: "#8080802e", borderRightStyle: "solid" }}>
                ...
                <div className="row g-4">
                  ...
                  <div className="col-md-4">
                    ...
                    <input type="number"  value={formData?.sort_order} name="sort_order" className="form-control  p-3" placeholder="1" onChange={handleChange} />
                  </div>

                  <div className="col-12">
                    <label className="form-label fw-bold small text-uppercase text-secondary">Description <span className='text-danger'>*</span></label>
                    <textarea name="description" value={formData?.description} className="form-control  p-3" rows="8" placeholder="Briefly describe this Package..." onChange={handleChange}></textarea>
                  </div>
                  ...
                  <div className="col-12 pt-3">
                    {postLoading ?
                      ...
                      :
                      <button onClick={handleUpdatePackage} type="button" className="btn btn-primary px-5 py-3 rounded-pill fw-bold shadow-sm w-100 w-md-auto">
                        Update Package
                      </button>
                    }
                  </div>
              ...
              <div className="col-lg-5">
                ...
                <div className="p-4">
                  ...
                  <div className="col-12">
                    <MultiMediaUpload images={images} setImages={setImages} videos={videos} setVideos={setVideos} assets={assets} setDeletedAssets={setDeletedAssets} deletedAssets={deletedAssets} />
                  </div>
                </div>
              </div>
            </div>
