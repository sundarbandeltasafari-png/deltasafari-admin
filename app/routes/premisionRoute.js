// Permision
export const getMainPermisionRouteUrl = `${process.env.NEXT_PUBLIC_SERVER_URL}admin/user/getPermisionMainRoute`;
export const createPermisionUrl = `${process.env.NEXT_PUBLIC_SERVER_URL}admin/user/createPermision`;
