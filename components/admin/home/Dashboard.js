                ...
                <div className="card bg-transparent shadow-none border-0 mb-6">
                    <div className="card-body row g-6 p-0 pb-5">
                        <div className="col-12 col-md-8 card-separator">
                            <h5 className="mb-2">Welcome back,<span className="h4 fw-semibold"> Felecia 👋🏻</span></h5>
                            ...
                            <div className="d-flex justify-content-between flex-wrap gap-4 me-12">
                                <div className="d-flex align-items-center gap-4 me-6 me-sm-0">
                                    ...
                                    <div className="content-right">
                                        <p className="mb-1 fw-medium">Hours Spent</p>
                                        <span className="text-primary mb-0 h5">34h</span>
                                    </div>
                                </div>
                                <div className="d-flex align-items-center gap-4">
                                    ...
                                    <div className="content-right">
                                        <p className="mb-1 fw-medium">Test Results</p>
                                        <span className="text-info mb-0 h5">82%</span>
                                    </div>
                                </div>
                                <div className="d-flex align-items-center gap-4">
                                    <div className="avatar avatar-lg">
                                    ...
                                    <div className="content-right">
                                        <p className="mb-1 fw-medium">Course Completed</p>
                                        <span className="text-warning mb-0 h5">14</span>
                                    </div>
                                </div>
                            </div>
                        </div>
                                ...
                                <div className="col-md-6 d-flex justify-content-around align-items-center">
                                    <div>
                                        <div className="d-flex align-items-baseline">
                                            <span className="text-primary me-2"><i className="icon-base ri ri-circle-fill icon-12px"></i></span>
                                            <div>
                                        ...
                                        <div className="d-flex align-items-baseline my-10">
                                            <span className="text-success me-2"><i className="icon-base ri ri-circle-fill icon-12px"></i></span>
                                            <div>
                                        ...
                                        <div className="d-flex align-items-baseline">
                                            <span className="text-danger me-2"><i className="icon-base ri ri-circle-fill icon-12px"></i></span>
                                            <div>
                                    ...
                                    <div>
                                        <div className="d-flex align-items-baseline">
                                            <span className="text-info me-2"><i className="icon-base ri ri-circle-fill icon-12px"></i></span>
                                            <div>
                                        ...
                                        <div className="d-flex align-items-baseline my-10">
                                            ...
                                            ><i className="icon-base ri ri-circle-fill icon-12px"></i
                                            ></span>
                                            <div>
                                        ...
                                        <div className="d-flex align-items-baseline">
                                            <span className="text-warning me-2"><i className="icon-base ri ri-circle-fill icon-12px"></i></span>
                                            <div>
                    ...
                    <div className="col-md-6 col-xxl-4">
                        <div className="card h-100">
                            ...
                            <div className="px-5 py-4 border border-start-0 border-end-0">
                                <div className="d-flex justify-content-between align-items-center">
                                    <h6 className="mb-0 fs-xsmall text-uppercase fw-normal">Instructors</h6>
                                    <h6 className="mb-0 fs-xsmall text-uppercase fw-normal">courses</h6>
                                </div>
                            </div>
                                ...
                                <ul className="list-unstyled mb-0">
                                    <li className="d-flex mb-7">
                                        <div className="avatar flex-shrink-0 me-4">
                                            ...
                                            ><i className="icon-base ri ri-vidicon-line icon-24px"></i
                                            ></span>
                                        </div>
                                    ...
                                    <li className="d-flex mb-7">
                                        <div className="avatar flex-shrink-0 me-4">
                                            ...
                                            ><i className="icon-base ri ri-code-fill icon-24px"></i
                                            ></span>
                                        </div>
                                        <div className="d-sm-flex w-100 align-items-center">
                                            <div className="w-100 mb-2 mb-sm-0 me-sm-4">
                                    ...
                                    <li className="d-flex mb-7">
                                        <div className="avatar flex-shrink-0 me-4">
                                            ...
                                            ><i className="icon-base ri ri-image-2-line icon-24px"></i
                                            ></span>
                                        </div>
                                        <div className="d-sm-flex w-100 align-items-center">
                                            <div className="w-100 mb-2 mb-sm-0 me-sm-4">
                                    ...
                                    <li className="d-flex mb-7">
                                        <div className="avatar flex-shrink-0 me-4">
                                            ...
                                            ><i className="icon-base ri ri-palette-line icon-24px"></i
                                            ></span>
                                        </div>
                                        <div className="d-sm-flex w-100 align-items-center">
                                            <div className="w-100 mb-2 mb-sm-0 me-sm-4">
                                    ...
                                    <li className="d-flex">
                                        <div className="avatar flex-shrink-0 me-4">
                                            ...
                                            ><i className="icon-base ri ri-music-2-line icon-24px"></i
                                            ></span>
                                        </div>
                                        <div className="d-sm-flex w-100 align-items-center">
                                            <div className="w-100 mb-2 mb-sm-0 me-sm-4">
                                ...
                                <div className="row mb-6 g-4">
                                    <div className="col-6">
                                        <div className="d-flex">
                                            <div className="avatar flex-shrink-0 me-4">
                                                <span className="avatar-initial rounded-3 bg-label-primary"
                                                ><i className="icon-base ri ri-calendar-line icon-24px"></i
                                                ></span>
                                            </div>
                                            <div>
                                    ...
                                    <div className="col-6">
                                        <div className="d-flex">
                                            <div className="avatar flex-shrink-0 me-4">
                                                <span className="avatar-initial rounded-3 bg-label-primary"
                                                ><i className="icon-base ri ri-time-line icon-24px"></i
                                                ></span>
                                            </div>
                                            <div>
                                        ...
                                        <div className="row w-100 align-items-center">
                                            ...
                                            <div className="col-3 text-end">
                                                <button type="button" className="btn btn-sm btn-icon bg-label-secondary">
                                                    <i className="icon-base ri ri-arrow-right-s-line icon-20px scaleX-n1-rtl"></i>
                                                </button>
                                            </div>
                                        </div>
                                    </li>
