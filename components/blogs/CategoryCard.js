...
function CategoryCard({ category, level }) {
        ...
        >
          <div className="d-flex align-items-start w-100 me-3">
            ...
            <div className="position-relative flex-shrink-0">
              <img
                src={process.env.NEXT_PUBLIC_SERVER_URL + category.image}
                alt={category.name}
            ...
            <div className="flex-grow-1 ms-3">
              <div className="d-flex justify-content-between align-items-center">
                <h6 className="fw-bold mb-0 text-dark">{category.name}</h6>
              ...
              {permisions.includes('/news/editcategory') && <div onClick={(e)=>{route.push('/news/editcategory/'+urlEncode(category?.id))}} className ='position-relative mt-3 btn btn-primary'>+ Edit Category</div>}
            </div>
